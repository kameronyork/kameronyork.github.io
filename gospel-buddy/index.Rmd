...
To determine the percentage the extension searches for the longest unbroken string of words from the scripture in the talk.  The length of this string is then compared to the length of the verse and a percentage is displayed.  This column is meant to assist users in determining which conference talks quote the scripture and which simply use it as a footnote.

<br>
![Studying General Conference Talks with the Gospel Buddy Extension](https://kameronyork.com/docs/assets/reference-table.png){.large-image}
<br>
<br>
