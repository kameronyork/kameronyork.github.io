...
<script src="C:/Users/theka/Desktop/Projects/Website_project/kameronyork.com/gospel-buddy/search.js"></script>

<div style="text-align: center;">
  <input type="text" id="scriptureInput" placeholder="Enter scripture reference (e.g., Matthew 18:21 or 1 Nephi 3:7-9)" style="width: 60%; padding: 10px; margin-top: 20px;">
