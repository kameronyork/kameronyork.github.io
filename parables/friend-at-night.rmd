...
<a class="nav nav-prev" href="https://kameronyork.com/parables/hidden-treasure.html" style="background-color: transparent; color: black; padding: 5px 10px; border: 1px solid lightgray; cursor: pointer; white-space: nowrap; font-size: 12px; display: flex; align-items: center;" 
