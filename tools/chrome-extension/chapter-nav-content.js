function createButtonWithExtractedURLNav(verseNumber, verseNumberText, scriptureCountNav, savedColorNav, scripturePathNav) {
  ...
  chrome.storage.sync.get('apostleOnly', function (data) {
    ...
    let scriptureQuotedDataUrlNav = 'https://www.kameronyork.com/datasets/all-footnotes-oct-2024.json';
    if (apostleOnlyNav) {
      scriptureQuotedDataUrlNav = 'https://www.kameronyork.com/datasets/apostle-all-footnotes-oct-2024.json';
    }
    ...
    for (const article of articlesNav) {
      ...
      const promises = Array.from(verseNumbersNav).map(async (verseNumber) => {
        ...
        if (dataURINav) {
          ...
          let scriptureQuotedDataUrlNav = 'https://www.kameronyork.com/datasets/all-footnotes-lookup-oct-2024.json';
          if (apostleOnlyNav) {
            scriptureQuotedDataUrlNav = 'https://www.kameronyork.com/datasets/apostle-all-footnotes-lookup-oct-2024.json';
          }
