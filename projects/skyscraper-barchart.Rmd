...
header-includes:
  - '<link rel="canonical" href="https://www.kameronyork.com/projects/skyscraper-barchart.html">'
  - '<meta property="og:title" content="Power BI Skyscraper Bar Chart">'
  - '<meta property="og:description" content="Transform your data into a city skyline with this custom Power Bi visual!">'
  - '<meta property="og:image" content="https://www.kameronyork.com/assets/img/scraper-icon.png">'
  - '<meta property="og:url" content="https://www.kameronyork.com/projects/skyscraper-barchart.html">'
  - '<meta property="og:type" content="website">'
  - '<meta property="og:site_name" content="Kameron York">'
  - '<meta name="twitter:card" content="summary_large_image">'
  - '<meta name="twitter:title" content="Power BI Skyscraper Bar Chart">'
  - '<meta name="twitter:description" content="Transform your data into a city skyline with this custom Power Bi visual!">'
  - '<meta name="twitter:image" content="https://www.kameronyork.com/assets/img/scraper-icon.png">'
---
<style>
...
<div class="subtitle-text">
  <a href="https://www.kameronyork.com/docs/skyscraper-barchart.pbiviz" class="download-button">
    <img src="https://www.kameronyork.com/assets/img/powerbi-logo.png" alt="Google Chrome Logo">
    Download Here
  </a>
</div>
...
<div style="display: flex; justify-content: space-around; align-items: center;">
  <img src="https://www.kameronyork.com/assets/img/scraper-day-example.png" style="width: 30%; margin-right: 1%;">
  <img src="https://www.kameronyork.com/assets/img/scraper-sunset-example.png" style="width: 30%; margin-right: 1%;">
  <img src="https://www.kameronyork.com/assets/img/scraper-night-example.png" style="width: 30%;">
</div>
...
To learn more about the process of building this custom visual [click here](https://www.kameronyork.com/blog/building-skyscraper-barchart.html).
<br>
<br>