...
<br>
<i>Below you will find three images displaying the style of each "time of day" setting.</i>
...
#### Where can I download the Skyscraper Barchart visual?

Simply click here to download this visual for use in Power Bi reports.  This will download a .pbiviz file to your device which can be imported to a Power Bi desktop report.
...
To import this visual to a Power Bi Desktop report:
...
The visual has now been imported to the report.  Now simply select it from the Visualization pane and input data.
...
Along with gaining a basic understaning of Power Bi custom visuals I used this project as an opportunity to practice design.  Using canva I created every image displayed in the visual from the skyscrapers to the backgrounds.  This was a learning curve for me, but I am extremely proud of the look and feel of the visual.
