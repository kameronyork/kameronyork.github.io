...
book_ordering_work <- verses %>% 
  group_by(book) %>% 
  summarise(book_order = min(verse_id)) %>% 
  arrange(book_order)
...
ggsave(filename = "C:/Users/theka/Pictures/my_plot2.png", plot = my_plot2, width = 8, height = 40, units = "in", limitsize = FALSE, bg = "white")
```
