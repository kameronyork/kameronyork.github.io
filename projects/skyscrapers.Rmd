...
header-includes:
  - '<link rel="canonical" href="https://www.kameronyork.com/projects/skyscrapers.html">'
  - '<meta property="og:title" content="Skyscrapers">'
  - '<meta property="og:description" content="Exploring the tallest buildings in the world.">'
  - '<meta property="og:image" content="https://www.kameronyork.com/assets/img/scraper-article-header.png">'
  - '<meta property="og:url" content="https://www.kameronyork.com/projects/skyscrapers.html">'
  - '<meta property="og:type" content="website">'
  - '<meta property="og:site_name" content="Kameron York">'
  - '<meta name="twitter:card" content="summary_large_image">'
  - '<meta name="twitter:title" content="Skyscrapers">'
  - '<meta name="twitter:description" content="Exploring the tallest buildings in the world.">'
  - '<meta name="twitter:image" content="https://www.kameronyork.com/assets/img/scraper-article-header.png">'
---
<br>
...
# GDP is in Billions.
gdp_1960 <- read.csv("https://www.kameronyork.com/datasets/gdp-data.csv", sep = ",") %>% 
...
pop_1960 <- read.csv("https://www.kameronyork.com/datasets/population-by-country.csv") %>% 
...
skyscraper_1960 <- read.csv("https://www.kameronyork.com/datasets/skyscraper-by-country.csv") %>% 
...
<small><i>(I have decided to omit countries with only one skyscraper and small populations as they seemed to skew the data)</i></small>
