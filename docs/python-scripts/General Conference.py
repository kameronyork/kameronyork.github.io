...
# Sample DataFrame
df = pd.read_csv("C:/Users/theka/Desktop/Projects/Website_project/kameronyork.github.io/datasets/general-conference-talks.csv", encoding="utf_8")
all_verses = pd.read_csv("C:/Users/theka/Desktop/Projects/Website_project/kameronyork.github.io/datasets/all-verses.csv", encoding="utf_8")
all_chapters = pd.read_csv("C:/Users/theka/Desktop/Projects/Website_project/kameronyork.github.io/datasets/all-chapters.csv", encoding="utf_8")
...
no_see = df[~df['quote_output'].str.startswith(('See', 'see'))]
...
with tqdm(total=len(no_see)) as pbar:
    for index, row in no_see.iterrows():
...
no_see["reference_type"] = results

# %% 
# Save the DataFrame
no_see = no_see.drop(columns=["text", "footnotes", "check", "Transformations"])
no_see.to_csv('full_quotes.csv', encoding='utf-8-sig')


# %%
# Create two data frames.
scripture_quotes = (no_see.query("reference_type == 'Scrip'"))
non_scrip_quotes = (no_see.query("reference_type == 'Non-Scrip'"))


# %%
# Printing to csv:
scripture_quotes.to_csv('new-testing.csv', index=False, encoding='utf-8')
