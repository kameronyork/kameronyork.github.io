...
```{r meta-tags, echo=FALSE, include = FALSE}
library(metathis)

meta() %>%
  meta_description(
    "Using Python code and a pocket-sized e-reader to start reading on the go."
  ) %>%
  meta_social(
    title = "Building a Pocket-Sized Library",
    description = "Using Python code and a pocket-sized e-reader to start reading on the go.",
    url = "https://www.kameronyork.com/blog/e-reader-ocr.html",
    image = "https://www.kameronyork.com/assets/img/ocr-header.png",
    image_alt = "A homemade book scanner built from a cardboard box",
    og_type = "article",
    og_site_name = "Kameron York",
