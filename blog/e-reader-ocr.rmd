...
If you would like to use the code I created in this project to create an EPUB file from a PDF, <a href="https://kameronyork.com/docs/zip-files/book2epub_sample.zip">click here</a>. That’s a starter ZIP file for the Python project I’ve been using to create my EPUB files.
