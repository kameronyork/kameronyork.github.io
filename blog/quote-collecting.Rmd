...
From there I created my [General Conference Analyses](https://kameronyork.com/projects/conference/).  The csv files of all Conference talks, and all scriptures quotes in conference are freely available for download on the dataset section of my website [Here](https://kameronyork.com/datasets).
