...
const bookDecoder = {
      ...
      for (const section of sections) {
        ...
        if (firstLink) {
          ...
          if (langIndex > -1) {
            ...
            const verseNumbers = section.querySelectorAll('.reference-UoeCG .verse .verse-number');
  ...
  replaceVerseNumbersWithButtonsSideBar(() => {
    ...
    function checkingButtonsExist() {
      const verseNumbers = document.querySelectorAll('.footnotePanel-PLlDp .verse .verse-number, .crossRefPanel-pyz6M .verse .verse-number');
