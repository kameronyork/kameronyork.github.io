function createButtonWithExtractedURL(verseNumber, verseNumberText, scriptureCountSB, savedColorSB, scripturePathSB) {
  ...
  chrome.storage.sync.get('apostleOnly', function (data) {
    ...
    let scriptureQuotedDataUrlSB = 'https://kameronyork.com/datasets/all-footnotes-oct-2024.json';
    if (apostleOnlySB) {
      scriptureQuotedDataUrlSB = 'https://kameronyork.com/datasets/apostle-all-footnotes-oct-2024.json';
    }
          ...
          if (langMatch) {
            ...
            const promises = Array.from(verseNumbersSB).map(async (verseNumber) => {
              ...
              if (!createdButtons.has(verseNumber)) {
                ...
                let scriptureQuotedDataUrlSB = 'https://kameronyork.com/datasets/all-footnotes-lookup-oct-2024.json';
                if (apostleOnlySB) {
                  scriptureQuotedDataUrlSB = 'https://kameronyork.com/datasets/apostle-all-footnotes-lookup-oct-2024.json';
                }
